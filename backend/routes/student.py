...
from schemas import (
    StudentCreate, StudentLogin, ChangePassword, StudentToken,
...
async def student_login(
    student: StudentLogin, db: AsyncSession = Depends(get_db)
):
    """
...
@router.get("/me")
async def get_logged_in_student(current_student: Student = Depends(get_current_student),):
    return {
